...
export const metadata: Metadata = {
  title: 'DomeoLeao — Simulador IRPF 2026 | Pague o Minimo, Receba o Maximo',
  description:
  ...
  twitter: {
    ...
    title: 'DomeoLeao — Dome o Leao do Imposto de Renda 2026',
...
const jsonLd = {
  ...
  '@type': 'WebApplication',
  name: 'DomeoLeao — Simulador IRPF 2026',
